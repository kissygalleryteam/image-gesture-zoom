/*
Tue Aug 26 2014 18:38:47 GMT+0800 (中国标准时间)
combined files by KMD:

index.js
*/

KISSY.add('kg/image-gesture-zoom/2.0.0/index',["node","scroll-view","scroll-view/plugin/scrollbar"],function(S ,require, exports, module) {
/**
 * @fileoverview 
 * @author yiminghe<yiminghe@gmail.com>
 * @module image-gesture-zoom
 **/
...
if(S.Features.getTransformProperty){
	transformProperty = S.Features.getTransformProperty();
}else{
	transformProperty = S.Features.getVendorCssPropName('transform');
}
